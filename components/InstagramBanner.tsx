    ...
    <section className="py-16 bg-gradient-to-r from-purple-50 via-pink-50 to-orange-50">
      <div className="container-custom">
        <motion.a
          ...
          viewport={{ once: true }}
          className="relative flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-8 group cursor-pointer rounded-3xl bg-white/80 border border-pink-100/70 shadow-[0_18px_45px_rgba(244,114,182,0.20)] px-6 sm:px-10 py-6 sm:py-7 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_55px_rgba(236,72,153,0.28)]"
        >
          ...
          <div className="mt-2 sm:mt-0">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-pink-500 to-orange-400 px-4 py-2 text-sm font-medium text-white shadow-md group-hover:shadow-lg group-hover:translate-x-0.5 transition-all duration-300">
              Visitar perfil
