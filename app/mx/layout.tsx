...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://paternidadprenatal.com/mx/',
    languages: {
      ...
      'es-MX': 'https://paternidadprenatal.com/mx/',
    },
  },
  openGraph: {
    title: country.metaTitle,
    ...
    url: 'https://paternidadprenatal.com/mx/',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Test Paternidad Prenatal ${country.name}`,
      },
    ],
  },
  twitter: {
...
export default function MexicoLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <link rel="alternate" hrefLang="es-MX" href="https://paternidadprenatal.com/mx/" />
      <link rel="alternate" hrefLang="x-default" href="https://paternidadprenatal.com/" />
      <Script id="organization-schema-mx" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemas.organization) }} />
      <Script id="service-schema-mx" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemas.service) }} />
      <Script id="local-business-schema-mx" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemas.localBusiness) }} />
      {children}
    </>
  )
}
